...
if (empty($record)) {
      error();
    header('Location: logIn.php'); //redirects users to admin page

} else {
   //echo "Successful login!";
    $_SESSION['username'] = $record['username'];
    $_SESSION['adminFullName'] = $record['FName'] . " " . $record['LName'];//creates a record in the session associative array
